...
interface ShelterDetailsRouteParams {
  id: number;
}
interface Shelter {
  id: number;
...
export default function ShelterDetails() {
  ...
  const params = route.params as ShelterDetailsRouteParams;
  useEffect(() => {
  ...
  function handleOpenGoogleMapRoutes() {
    Linking.openURL(
      `https://www.goolge.com/maps/dir/?api=1&destination=${shelter?.latitude}, ${shelter?.longitude}`
    );
  }
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.detailsContainer}>
        ...
        <Text style={styles.description}>{shelter.about}</Text>
        ...
        <Text style={styles.description}>{shelter.instructions}</Text>

        <View style={styles.scheduleContainer}>
          <View style={[styles.scheduleItem, styles.scheduleItemBlue]}>
            <Feather name="clock" size={40} color="#2AB5D1" />
            <Text style={[styles.scheduleText, styles.scheduleTextBlue]}>
              Segunda à Sexta {shelter.opening_hours}
            </Text>
          </View>
